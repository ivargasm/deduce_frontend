...
import { login, fetchUser, logout, register, refreshToken } from "../lib/api/auth";

interface AuthState {
    user: { id: string; username: string; email: string; role: string; terms_accepted?: boolean; exp?: number; created_at?: string } | null;
    ...
    registerUser: (username: string, email: string, password: string, accept_terms: boolean) => Promise<unknown>;
